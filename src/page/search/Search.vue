<template>
  <div>
    ...
    <div
      ...
      <ul
        ...
        <v-touch
          ...
          v-for="(searchHotWord, index) in searchHotWords"
          :key="index"
          @tap="fuzzySearch">
          {{ searchHotWord.word }}
        </v-touch>
      ...
      <div class="search-history">
        ...
        <ul class="history-list">
          <v-touch
            ...
            :key="index"
            @tap="fuzzySearch">{{ history }}</v-touch>
        </ul>
      </div>
    ...
    <ul
      ...
      v-if="autoCompleteList.length && searchWord">
      <v-touch
        tag="li"
...
export default {
  ...
  methods: {
    ...
    fuzzySearch (el) {
      ...
      // 设置搜索历史
      let searchHistory = util.getLocalStroageData('searchHistory')
        ? util.getLocalStroageData('searchHistory')
        : []
