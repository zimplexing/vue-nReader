  ...
  <div>
    <mt-tab-container
      ...
      <mt-tab-container-item id="分类">
        ...
        <keep-alive include="Bookshelf">
          <Bookcategory class="tab-container"/>
        </keep-alive>
      </mt-tab-container-item>
    ...
    <mt-tabbar
      ...
      <mt-tab-item id="书架">
        <img
          slot="icon"
          src="../assets/book.svg"> 书架
      </mt-tab-item>
      <mt-tab-item id="分类">
        <img
          slot="icon"
          src="../assets/category.svg"> 分类
      </mt-tab-item>
      <mt-tab-item id="排行">
        <img
          slot="icon"
          src="../assets/rank.svg"> 排行
      </mt-tab-item>
      <mt-tab-item id="搜索">
        <img
          slot="icon"
          src="../assets/search.svg">搜索
      </mt-tab-item>
    </mt-tabbar>
  </div>
</template>
